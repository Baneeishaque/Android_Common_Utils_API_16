...
public class REST_Insert_Task extends AsyncTask<Void, Void, String[]> {
    ...
    public REST_Insert_Task(String URL, AppCompatActivity current_activity, View progressBar, View form, String TAG, Pair[] name_value_pair, View focus_on_error, Class next_activity, EditText[] texts_to_clear) {
        this.URL = URL;
        this.current_activity = current_activity;
        this.progressBar = progressBar;
        this.form = form;
