...
public class SharedPreferenceUtils {
    ...
    public static void commitSharedPreferences(Context context, String application_name, Pair[] shared_preference_pairs) {
    ...
    public static boolean is_first_run(Context context, String application_name, First_Run_Actions first_run_actions) {
        ...
        if (settings.getString("first_run", String.valueOf(true)).equals(String.valueOf(true))) {
            ...
            commitSharedPreferences(context, application_name, new Pair[]{new Pair<>("first_run", String.valueOf(false))});
            return true;
        }
        return false;
    }
